...
class PipelineCdkStack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, ecr_repository, test_app_fargate, prod_app_fargate, green_target_group, green_load_balancer_listener, **kwargs) -> None:
        ...
        ssmParameter = ssm.StringParameter(
            ...
            string_value='arn:aws:signer:ap-south-1:130188826212:/signing-profiles/ecr_signing_profile'
        )
        ...
        source_action = codepipeline_actions.CodeStarConnectionsSourceAction(
          ...
          connection_arn = "arn:aws:codeconnections:us-east-2:252137487660:connection/16d64652-69c2-43f7-9719-94f7505dccfa"
        )
        ...
        email_subscription = subscriptions.EmailSubscription('hp.cho@nex4.net')
